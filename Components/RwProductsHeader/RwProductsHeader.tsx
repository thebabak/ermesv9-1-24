...
function RwProductsHeader() {
  ...
  return (
   ...
   <div
     ...
     onClick={() => {
      router.push(allAddresses.industrialProducts)
     }}
   >
    <div className="text-sm text-nowrap md:text-2xl lg:text-2xl xl:text-3xl font-semibold text-black bg-white rounded-lg px-1 lg:px-4 py-2"> Industrial Product </div>

    <Link href={allAddresses.industrialProducts} className="text-base md:text-3xl lg:text-4xl font-semibold text-white">See All</Link>
...
export default RwProductsHeader